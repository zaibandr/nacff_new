...
if(isset($_GET['code'])){
    $query = "select p.code, p.panel, m.mattype, c.contgroup, s.samplingrule, pr.description,p.checked, count(*) from panels p ";
    ...
    $query.= "group by p.code, p.panel,p.checked, m.mattype, c.contgroup, s.samplingrule, pr.description";
